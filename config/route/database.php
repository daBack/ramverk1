...
// $app->router->add("blog/**", [$app->DatabaseController, "connect"]);

// $di->router->add("blog/entries", [$app->DatabaseController, "entries"]);

return [
    "routes" => [
        [
            "info" => "Adds blog entries to router",
            "requestMethod" => null,
            "path" => "blog/entries",
            "callable" =>["DatabaseController", "entries"]
        ],
    ]
];
